...
export default {
    ...
    data: function(){
        return{
            ...
            search:undefined,  // 검색 창에서 입력되어지는 검색어
            source:'d',  // youtube메소드 논리 연산을 위한 객체
            condition:'' // 날씨 정보
        }
    },
    methods:{
        ...
        async youtube(){
            ...
            const fullUrl="https://www.googleapis.com/youtube/v3/search?part=snippet&q="+encodingSearch+"&key=AIzaSyCi9gnSKw2wgpuh0X04YiS-3GlC6lSCoo8&maxResults=2"
